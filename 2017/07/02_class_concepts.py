...
#   classes (which are classes that are not meant to be instantiated,
#   and which behave identically whether or not they are instantiated),
#   will be explored more later.
...
def custom_second_level_spells(new_spell: str) -> SecondLevelSpells:
    ...
    sls = SecondLevelSpells()
    sls.custom = new_spell
    return sls
